...
import 'package:flutter_list_mobx/serializers/news.dart';
import 'package:flutter_list_mobx/serializers/news_list.dart';
import 'package:flutter_list_mobx/utils/constants.dart';
...
//  for (int index = 0; index < newsIdList.length; index++) {
  ...
  for (int index = (indexRange - 10); index < indexRange; index++) {
